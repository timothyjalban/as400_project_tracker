...
const LINE_ITEM_FIELDS = [
  ...
  { key: 'style', label: 'Style', appliesTo: ['door', 'window', 'hardware'], control: 'select', group: 'catalog', default: '',
    render: { variants: {
      door: { label: 'Door Style', optionsSource: 'doorStyle',
        afterControl: '<button hidden type="button" class="item-add-style-button" data-add-style-type="door">➕ Add Style</button>' },
  ...
  { key: 'thickness', label: 'Thickness', appliesTo: ['door'], control: 'select', group: 'door-build', default: '',
    render: { label: 'Thickness', options: ['1-3/8"', '1-3/4"'], placeholder: 'Select thickness', valueFrom: ['prefit_thickness'] },
  ...
  { key: 'jamb_size', label: 'Jamb size', appliesTo: ['door'], control: 'select', group: 'door-build', default: '',
    render: { label: 'Jamb Size', optionsSource: 'jambSize', placeholder: 'Select jamb size',
      afterControl: '<button hidden type="button" class="item-add-style-button" data-add-jamb-size="true">➕ Add Jamb Size</button>' },
  ...
  { key: 'swing', label: 'Swing / Handing', appliesTo: ['door'], control: 'select', group: 'door-build', default: '',
    render: { label: 'Swing', options: ['RHIS', 'RHOS', 'LHIS', 'LHOS'], placeholder: 'Select swing', valueFrom: ['prefit_swing'] },
  ...
  { key: 'operation', label: 'Operation', appliesTo: ['window'], control: 'select', group: 'window-build', default: '',
    render: { label: 'Handing', optionsSource: 'winHanding', placeholder: 'Select handing',
      afterControl: '<button hidden type="button" class="item-add-style-button" data-add-handing="window">➕ Add Handing</button>' },
  ...
  { key: 'frame', label: 'Frame', appliesTo: ['door', 'window'], control: 'select', group: 'window-build', default: '',
    render: { label: 'Frame', options: ['Wood', 'Fiberglass', 'Aluminum', 'Vinyl'], onlyForType: 'window' },
  ...
  { key: 'glass', label: 'Glass', appliesTo: ['door', 'window'], control: 'select', group: 'window-build', default: '',
    render: { label: 'Glass', options: ['Clear', 'Low-E', 'Obscure'], placeholder: 'Select glass', onlyForType: 'window' },
  ...
  { key: 'door_count', label: 'Door count', appliesTo: ['door'], control: 'select', group: 'entry-door', default: '',
    render: { label: 'Door Count', options: ['Single', 'Double', 'Triple'], placeholder: 'Select' },
  ...
  { key: 'sidelites', label: 'Sidelites', appliesTo: ['door'], control: 'select', group: 'entry-door', default: '',
    render: { label: 'Sidelites', options: ['1L', '1R', '2'], placeholder: 'None' },
  ...
  { key: 'door_location', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Door Location', options: ['Interior', 'Exterior'], placeholder: 'Select location' } },
  { key: 'material', appliesTo: ['door', 'window'], control: 'select', group: 'door-detail', default: '',
    render: { label: 'Material', options: ['Wood', 'Primed', 'Fiberglass', 'Steel', 'Vinyl'], onlyForType: 'door' },
  ...
  { key: 'door_texture', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Texture', placeholder: 'Select texture', options: [
      'Smooth-Star', 'Classic Craft Fir Grain', 'Classic Craft Mahogany Grain', 'Classic Craft Canvas',
      'Fiber-Classic Oak Collection', 'Fiber-Classic Mahogany Collection', 'Traditions', 'Profiles'] } },
  { key: 'core', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '',
    render: { label: 'Core', options: ['Hollow Core', 'Solid Core'], placeholder: 'Select core' },
  ...
  { key: 'sticking', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '',
    render: { label: 'Sticking', options: ['Square', 'Ovolo', 'Shaker'], placeholder: 'Select sticking' },
  ...
  { key: 'glass_tint', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Glass Tint', options: ['Clear', 'Obscure', 'Low-E', 'Tempered'], placeholder: 'Select tint' } },
  { key: 'door_glass_shape', appliesTo: ['door'], control: 'text', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Lite Shape', placeholder: 'e.g. Full Lite Rectangle, Craftsman Rectangle' } },
  { key: 'door_glass_lite_style', appliesTo: ['door'], control: 'text', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Lite Style', placeholder: 'e.g. 10 Lite, 6 Lite Colonial' } },
  { key: 'door_frame_profile', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Lite Frame', options: ['Flat Lite Frame', 'Scrolled Lite Frame'], placeholder: 'Select lite frame' } },
  { key: 'finish_type', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Finish Type', options: ['Primed', 'Unfinished', 'Prefinished'], placeholder: 'Select finish type' } },
  { key: 'finish_detail', appliesTo: ['door'], control: 'text', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Wood Species / Stain Color', placeholder: 'e.g. Red Oak, or a stain color name' } },
  { key: 'panel_style', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Panel Style', placeholder: 'Select panel style', options: [
      '1 Panel', '2 Panel', '3 Panel', '4 Panel', '5 Panel', '6 Panel', '1 Lite', '2 Lite', '3 Lite',
      '5 Lite', '10 Lite', '15 Lite', 'Louver', 'Plank'] },
  ...
  { key: 'boring', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Boring', options: ['Single', 'Double', 'None'], placeholder: 'Select boring' } },
  { key: 'hinge_size', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Hinge Size', options: ['3"', '3-1/2"', '4"', '4-1/2"'], placeholder: 'Select hinge size' } },
  { key: 'hinge_finish', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Hinge Finish', placeholder: 'Select hinge finish', options: [
  ...
  { key: 'exterior_trim', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Exterior Trim', options: ['Brickmould', 'No Exterior Trim'], placeholder: 'Select trim' } },
  { key: 'sill', appliesTo: ['door'], control: 'text', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Sill', placeholder: 'e.g. Bronze, Mill Aluminum' } },
  { key: 'hardware_option', appliesTo: ['door'], control: 'select', group: 'door-detail', default: '', editorOnly: true,
    render: { label: 'Hardware', options: ['Standard', 'Lever', 'Knob', 'Deadbolt'], placeholder: 'Select hardware' } },
  ...
  { key: 'hardware_lever_knob_style', label: 'Lever / knob', appliesTo: ['hardware'], control: 'select', group: 'hardware', default: '',
    render: { label: 'Lever/Knob Style', optionsSource: 'hardwareLeverKnob', placeholder: 'Select lever/knob style' },
  ...
  { key: 'hardware_handing', label: 'Handing', appliesTo: ['hardware'], control: 'select', group: 'hardware', default: '',
    render: { label: 'Handing', options: ['LH', 'RH', 'Reversible', 'N/A'], placeholder: 'Select handing' },
  ...
  { key: 'hardware_backset', label: 'Backset', appliesTo: ['hardware'], control: 'select', group: 'hardware', default: '',
    render: { label: 'Backset', options: ['2-3/8"', '2-3/4"', 'Adjustable'], placeholder: 'Select backset' },
  ...
  { key: 'hardware_bore', label: 'Bore', appliesTo: ['hardware'], control: 'select', group: 'hardware', default: '',
    render: { label: 'Bore', options: ['Single Bore', 'Double Bore', 'Tubular Prep', 'Mortise Prep', 'N/A'], placeholder: 'Select bore' } },
  ...
  ...[
    ...
    { key: 'prefit_bore_diameter', control: 'select', default: '2 1/8"',
      render: { label: 'Bore Diameter', optionsSource: 'prefitBoreDiameter', placeholder: 'Select bore diameter', defaultValue: '2 1/8"' } },
  ].map(f => ({
